...
namespace Feeling.GIS.Map.Core
{
   ...
   internal class SQLitePureImageCache : PureImageCache
   {
      ...
      public string CacheLocation
      {
         ...
         set
         {
            ...
            string dir = gtileCache + Path.DirectorySeparatorChar;
   ...
   #region PureImageCache Members
      ...
      PureImage PureImageCache.GetImageFromCache(MapType type, MapPoint pos, int zoom)
      {
         PureImage ret = null;
         try
         {
                        ...
                        if(rd.Read())
                        {
                           ...
                           rd.GetBytes(0, 0, tile, 0, tile.Length);
                           {
                              if(MapsManager.Instance.ImageProxy != null)
                              {
                                 ...
                                 ret = MapsManager.Instance.ImageProxy.FromStream(stm);
                                 if(ret != null)
                                 {
                                    ret.Data = stm;
                                 }
